<%-- 
    Document   : WelcomeDelete
    Created on : Sep 12, 2022, 7:35:28 PM
    Author     : sai
--%>
...
<html>
    ...
    <body>
        ...
        <h1>YOU HAVE DELETED YOUR ACCOUNT SUCCESSFULLY, RETURN TO HOME PAGE!!</h1><br>
